...
./google-cloud-sdk/bin/gcloud compute ssh usman_kayani_ons_gov_uk@usman --project=ons-tddcp-data-collection --zone=europe-west2-a --command="sudo chown -R usman_kayani_ons_gov_uk /home/jupyter/" --quiet
